package org.loofer.retrofit.request;
...
public class Request {
    ...
    private Request(String url, String method, Headers headers, RequestBody body, Object tag) {
    ...
    @NonNull
    public Request addParameter(String key, Object o) {
        if (o instanceof String) {
     ...
     */
    @NonNull
    public Request addFilesByUri(String key, List<Uri> uris) {
